...
if __name__ == '__main__':
    ...
    parser.add_argument('--content_loss_coef', default=0.3, type=float)
    parser.add_argument('--style_loss_coef', default=0.7, type=float)
    ...
    args.checkpoint_path_style = r"/media/lab/sdb/zzc/myVQGAN/checkpoints/transformer_epoch_0.pt"
