...
class TrainVQGAN:
    def __init__(self, args):
        ...
        self.vqgan.load_checkpoint(args.checkpoint_vggans_pretrain)
        ...
        for epoch in range(args.epochs):
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    torch.save(self.vqgan.state_dict(), os.path.join("checkpoints", f"vqganA_epoch_{epoch+args.pre_epoch}.pt"))
...
if __name__ == '__main__':
    ...
    args.pre_epoch=11
    args.checkpoint_vggans_pretrain=r"/media/lab/sdb/zzc/myVQGAN/checkpoints/vqganA_epoch_10.pt"
    args.checkpoint_vggans_pretrain=r"/ media / lab / sdb / zzc / myVQGAN1 / checkpoints / vqganB_epoch_10.pt"
    #args.dataset_path = [r"/media/lab/sdb/zzc/zhangdaqian",r"/media/lab/sdb/zzc/A"]
    args.dataset_path = [ r"/media/lab/sdb/zzc/B"]
    args.dataset_path = [r"/media/lab/sdb/zzc/input/style"]
